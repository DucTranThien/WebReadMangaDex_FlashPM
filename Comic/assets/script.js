document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadManga(page) {
        fetch(`http://localhost/Comic/api/get_latest_manga.php?page=${page}`)
            ...
            .then(data => {
                ...
                data.data.forEach(manga => {
                    ...
                    // Fetch cover
                    const coverUrlApi = `http://localhost/Comic/api/get_cover.php?id=${encodeURIComponent(manga.id)}`;
                    fetch(coverUrlApi)
                        .then(res => res.json())
                        .then(coverData => {
                ...
                if (!mangaCache[nextBatchPage]) {
                    fetch(`http://localhost/Comic/api/get_latest_manga.php?page=${nextBatchPage}`)
                        .then(res => res.json())
                        .then(nextData => {
