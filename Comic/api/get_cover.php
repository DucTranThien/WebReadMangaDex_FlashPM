...
if ($result->num_rows > 0) {
    ...
    $coverUrl = $row['cover_url'] ?: "http://localhost/Comic/assets/images/default.jpg"; // Use absolute path
} else {
    ...
    if ($response === false || $httpCode !== 200) {
        $coverUrl = "http://localhost/Comic/assets/images/default.jpg"; // Use absolute path
    } else {
        ...
        $coverUrl = $cover 
            ...
            : "http://localhost/Comic/assets/images/default.jpg"; // Use absolute path
    }
}
